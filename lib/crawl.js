...
function scoreInternalLink(link) {
  ...
  if (/\/page\/\d+/.test(href)) score -= 12;
  if (href.includes('/label/')) score -= 12;
  if (href.includes('/search')) score -= 12;
...
function scoreQueueUrl(url, startUrl) {
  ...
  if (href.includes('/label/')) score -= 20;
  if (href.includes('/search')) score -= 15;
  ...
  if (
    ...
    href.includes('max-results=') ||
    href.includes('updated-max=') ||
    href.includes('sort=') ||
